import json
with open(r'C:\Users\LUIS\Desktop\previsoes_dados_agua\modelo_V3\novo_modelo_correnteza_V3.py', 'r', encoding='utf-8') as f:
    content = f.read()
...
with open(r'C:\Users\LUIS\Desktop\previsoes_dados_agua\modelo_V3\novo_modelo_correnteza_V3.ipynb', 'w', encoding='utf-8') as f:
