import json
with open(r'C:\Users\LUIS\Desktop\previsoes_dados_agua\modelo_V5\novo_modelo_correnteza_V5.py', 'r', encoding='utf-8') as f:
    content = f.read()
cells = []
...
with open(r'C:\Users\LUIS\Desktop\previsoes_dados_agua\modelo_V5\novo_modelo_correnteza_V5.ipynb','w',encoding='utf-8') as f:
